...
export class ZardTableComponent {
  ...
  protected readonly classes = computed(() =>
    mergeClasses(tableVariants({ zType: this.zType(), zSize: this.zSize() }), this.class()),
  );
}
...
export class ZardTableHeadComponent {
  ...
  protected readonly classes = computed(() =>
    mergeClasses(tableHeadVariants({ zSize: this.parentTable?.zSize() ?? 'default' }), this.class()),
  );
}
...
export class ZardTableCellComponent {
  ...
  protected readonly classes = computed(() =>
    mergeClasses(tableCellVariants({ zSize: this.parentTable?.zSize() ?? 'default' }), this.class()),
  );
}
